...
$Script:Runtime = Measure-Command -Expression {
  ...
  function Get-HelpMessage {
    ...
    Write-Host ' -GenerateRecommendationsCSV    :  Switch; generates an additional CSV file with the recommendations. '
  ...
  function Build-RecommendationsCSVFile {
    $csvPath = $ExcelFile -replace '.xlsx', '_Recommendations.csv'
    $Script:RecommendationsCsv | Export-Csv -Path $csvPath -NoTypeInformation
  }
