...
| Key                    | Example Value                                                                                                                                               | Data Type | Description                                                                                                                              | Allowed Values                                                                                                                                             |
|:-----------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------|:----------|:-----------------------------------------------------------------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------|
| pageTitle              | Do not use classic Storage Account                                                                                                                          | String    | Summarization of your recommendation                                                                                                     | N/A                                                                                                                                                        |
| recommendationImpact   | High                                                                                                                                                        | String    | Importance of adopting the recommendation and/or the risk of choosing not to adopt                                                       | Low, Medium, High                                                                                                                                          |
| recommendationControl  | Governance                                                                                                                                                  | String    | WAF pillar associated to the recommendation                                                                                              | Reliability, Security, Performance, OperationalExcellence, PerformanceEfficiency                                                                           |
| recommendationCategory | Reliability                                                                                                                                                 | String    | Category of recommendation based upon the recommmendationControl value                                                                   | HighAvailabilityy, BusinessContinuity, DisasterRecovery, Scalability, MonitoringAndAlerting, ServiceUpgradeAndRetirement, OtherBestPractices, Personalized |
| tags                   | Not Workload Specific                                                                                                                                       | String    | Generalized tags used for incorporating fields to automate                                                                               | N/A                                                                                                                                                        |
| publishedToLearn       | false                                                                                                                                                       | Boolean   | Indicates whether the recommendation is published to [Microsoft Learn](https://learn.microsoft.com/en-us/azure/well-architected/pillars) | true, false                                                                                                                                                |
| publishToAdvisor       | false                                                                                                                                                       | Boolean   | Indicates whether the recommendation is published to Azure Advisor                                                                       | true, false                                                                                                                                                |
| pgVerified             | false                                                                                                                                                       | Boolean   | Indicates whether the recommendation is verified by relevant product group                                                               | true, false                                                                                                                                                |
| automationAvailable    | true                                                                                                                                                        | Boolean   | Indicates whether automation is available for validating the recommendation                                                              | true, false                                                                                                                                                |
| recommendationTypeId   | 63ad027e-611c-294b-acc5-8e3234db9a40                                                                                                                        | String    | The unique identifier for the recommendation                                                                                             | 32-character hexadecimal string                                                                                                                            |
| state                  | Active                                                                                                                                                      | String    | Indicates whether the recommendation is visible                                                                                          | Active, Removed                                                                                                                                            |
| longDescription        | Azure classic Storage Account will retire 31 august 2024. So migrate all workload from classic storage to v2.                                               | String    | Detailed description of the recommendation and its implications                                                                          | N/A                                                                                                                                                        |
| potentialBenefits      | Improved security and modern features                                                                                                                       | String    | The potential benefits of implementing the recommendation                                                                                | The length should be less than 60 characters                                                                                                               |
| learnMoreLink          | - name: Storage Account Retirement Announcement url: "https://azure.microsoft.com/updates/classic-azure-storage-accounts-will-be-retired-on-31-august-2024" | Object    | Links related to the recommendation, such as announcements or documentation                                                              | Only 3 links per recommendation                                                                                                                            |
