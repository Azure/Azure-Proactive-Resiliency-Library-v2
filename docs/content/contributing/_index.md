...
| recommendationControl  | Governance                                                                                                                                                  | String    | High Availability, Business Continuity, Disaster Recovery, Scalability, Monitoring and Alerting, Service Upgrade and Retirement, Other Best Practices, Personalized | WAF pillar associated with the recommendation                                                                                            |
| recommendationCategory | Reliability                                                                                                                                                 | String    | Reliability, Security, Performance, Operational Excellence, Performance Efficiency                                                                                  | Category of recommendation based upon the recommendationControl value                                                                    |
...
| recommendationTypeId   | 63ad027e-611c-294b-acc5-8e3234db9a40                                                                                                                        | String    | 32-character hexadecimal string                                                                                                                                     | The unique identifier for the recommendation                                                                                             |
